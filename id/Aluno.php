...
<div id="main">
   ...
   <div id="palco2">
    ...
    <!-- Dados do Aluno -->
		...
		<input type="text" name="Data" id="Data" class="textbox2"  tabindex="4" onKeyUp="Formatadata(this,event);"  size="14" maxlength="10" title="Informe a data da matrícula"/><br />
		<br />
		...
		<input type="text" name="Certidao" id="Certidao" class="textbox2"  tabindex="7"  title="Informe o nº da certidão de nascimento"/><br />
		<br />
		...
		<input type="text" name="Profpai" id="Profpai" class="textbox"   tabindex="20" title="Informe a profissão do Pai" /><br />
		<br />
		...
		<input type="text" name="CelMae" id="CelMae" class="textbox2"  tabindex="18" maxlength="13" onkeypress="return txtBoxFormat(document.Form, 'CelMae', '(99)9999-9999', event);" title="Informe o Celular da Mãe" /><br />
		<br />
        <label for="Profmae">Profiss&atilde;o da Mãe:</label>
		<input type="text" name="Profmae" id="Profmae" class="textbox" tabindex="22" title="Informe a profissão da Mae" /><br />
		<br />
      ...
      <!-- <label for="Foto">Foto:</label>
       ...
       <label for="Endereco">Endere&ccedil;o:</label>
		<input type="text" name="Endereco" id="Endereco" class="textbox" tabindex="13" title="Informe o endereço" /><br />
		<br />
		...
		<input type="text" name="Email" id="Email" class="textbox" tabindex="23" onBlur="ValidEmail();" title="Informe um email válido" />
		<br /><br />
        <center>------------------ Dados Gerais --------------------- </center>
        <label for="Inclusao">Inclus&atilde;o:</label>
        <select name="Transferencia"  class="textbox3" tabindex="24" title="Informe a origem da inclusão">
    		<option value"">Selecione...</option>
        ...
        <input type="text" name="Carne" id="Carne" class="textbox2" tabindex="26"  title="Informe o nº do Carnê" />

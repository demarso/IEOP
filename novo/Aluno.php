...
<!-- ************************************************************************************************ -->         <div class="form-group row mt-1 mb-1">
      ...
      &nbsp;&nbsp;<input type="text" name="Matric" id="Matric" size="30" hidden="true" >
		...
		<div class="form-group row mt-1 mb-1">
            ...
            <div class="col-md-2">
              <input type="date" name="Data" id="Data" class="textbox2"  tabindex="4"  onKeyPress="MascaraData(form1.Data);"  size="14" value="<? echo "$data" ?>" maxlength="10" title="Informe a data da matrícula"/>
            </div>
         ...
         <select name="Ano" id="Ano" class="textbox2" tabindex="5" obrigatorio="1" title="Informe o Ano que o aluno vai estudar">
       	...
       	<div class="form-group row mt-1 mb-1">
            ...
            <div class="col-md-2">
              <input type="text" name="Certidao" id="Certidao" class="textbox2"  tabindex="7" onkeypress="return Onlynumbers(event)"  title="Informe o nº da certidão de nascimento"/>
            </div>
        ...
        <div class="form-group row mt-1 mb-1">
            ...
            <div class="col-md-4">
              <input type="text" name="Profpai" id="Profpai" class="textbox" size="40"  tabindex="15" onkeypress="return Onlychars(event)" title="Informe a profissão do Pai" />
            </div>
        </div>
        <div class="form-group row mt-1 mb-1">
        ...
        <div class="form-group row mt-1 mb-1">
            ...
            <div class="col-md-4">
              <input type="text" name="CelMae" id="CelMae" class="textbox2"  tabindex="17"onKeyPress="MascaraCelular(form1.CelMae);" maxlength="15"  title="Informe o Celular da Mãe" />formato: (00) 00000-0000
            </div>
        </div>
		<div class="form-group row mt-1 mb-1">
            <label class="col-sm-2 col-form-label" for="Profmae">Profiss&atilde;o da M&atilde;e:</label>
            <div class="col-md-4">
              <input type="text" name="Profmae" id="Profmae" size="40" class="textbox" tabindex="18" onkeypress="return Onlychars(event)" title="Informe a profissão da Mae" />
            </div>
        </div>
      ...
      <!-- <label for="Foto">Foto:</label>
		...
		<div class="form-group row mt-1 mb-1">
            ...
            <div class="col-md-4">
              <input type="text" name="endereco" id="endereco" size="60" class="textbox" tabindex="19" title="Informe o endereço" />
            </div>
        </div>
        <div class="form-group row mt-1 mb-1">
		...
		<div class="form-group row mt-1 mb-1">
            ...
            <div class="col-md-4">
              <input type="text" name="Email" id="Email" size="40" class="textbox" tabindex="25" onBlur="ValidEmail();" title="Informe um email válido" />
            </div>
        </div>
		------------------ Dados Gerais ---------------------
        <div class="form-group row mt-1 mb-1">

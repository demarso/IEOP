        ...
        <div class="container">
          <div class="row align-items-center ">
            <div class="col-md-5 mt-5 pt-5">
              <span class="text-cursive h5 text-red">Bemvindos ao nosso Website</span>
              <h1 class="mb-3 font-weight-bold text-teal">Garanta o futuro de seus filhos</h1>
              <p>Ambiente seguro e saudável para suas crianças</p>
              <p class="mt-5"><a href="index_online.php" target="_blank"><img src="images/SAOnline.png" alt="Image" class="img-fluid" width="250"></a></p>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 ml-auto pl-md-5">
            <span class="text-cursive h5 text-red">Sobre o IEOP</span>
            <h3 class="text-black">Garanta o futuro de seus filhos</h3>
            ...
            <p class="mt-5"><a href="#" class="btn btn-warning py-4 btn-custom-1">Mais Informações</a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            ...
            <h2 class="text-white">Nossas Atividades</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="package text-center bg-white">
              ...
              <h3 class="text-teal">Recreação</h3>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="package text-center bg-white">
              ...
              <h3 class="text-success">Esportes</h3>
              <p>Lorem ipsum dolor sit amet. Consequatur aliquam, fuga maiores amet quo corporis distinctio soluta recusandae?</p>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="package text-center bg-white">
              ...
              <h3 class="text-danger">Atividades externas</h3>
              <p>Lorem ipsum dolor sit amet. Consequatur aliquam, fuga maiores amet quo corporis distinctio soluta recusandae?</p>
 ...
 <!--     <div class="site-section bg-light">
    ...
    <div class="site-section py-5 bg-warning">
      <div class="container">
        <div class="row justify-content-center">
          ...
          <h2 class="text-white m-0">Instituto Educacional Oliveira Pessoa IEOP</h2>
          <a href="#" class="btn btn-primary btn-custom-1 py-3 px-5 ml-auto">Comece aqui</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <footer class="site-footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <h2 class="footer-heading mb-3">Fale Conosco</h2>
                <p class="mb-5">(21) 3764-2593. </p>

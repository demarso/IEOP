...
<? include("head.php"); ?> 
 ...
 <div id="main">
  ...
  <br /><br /><br />
  <fieldset>
    	<legend>Altera Resultado Final do Aluno do &ordm; Ano</legend>
    <form name = "form1" method = "post" action = "AlteraResultado1.php" enctype = "multipart/form-data">
      ...
      <select name="Nome" id="Nome" class="textbox" onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)" d>
        ...
        <?php
			            ...
			            //Busco os estados
						$sql3 = "SELECT a.Nome FROM aluno a, histMatr h WHERE a.Nome = h.Nome && a.Status = 'Ativo' && h.Turma = '8 Ano' && h.Ano = '$ano' ORDER BY h.Chamada";

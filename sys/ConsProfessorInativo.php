...
<div id="main">
   ...
   <div id="palco2"><br /><br />
      <form action="ConsProfessorOK.php" method="post" enctype="multipart/form-data" name="cadastro" >
	<fieldset id="forms">
		<legend>Consulta de Professor Inativo</legend><br /><br />
  <label for="Nome">Nome:</label><select name="Nome" id="Nome" class="textbox3" >
           <option value="">Selecione</option>
        				<?php
			            //Busco os estados
						require_once("conexao.php");
						$sql3 = "SELECT Nome FROM professor WHERE Status = 'Inativo' ORDER BY Nome";

...
<div id="main">
   ...
   ?>
      <form action="DependenciaNotas1.php" method="post" enctype="multipart/form-data" name="cadastro" >
	<fieldset id="forms">
		<legend>Lança Notas da Dependência - Selecione o Aluno</legend><br /><br />
  ...
  <select name="Nome" id="Nome" class="textbox" onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)" d>
           <option value="" >Selecione</option>
						...
						$sql3 = "SELECT Nome FROM notasDepend WHERE Ano = '$ano2' GROUP BY Nome ORDER BY Nome";

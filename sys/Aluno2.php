...
<div id="main">
   ...
   <div id="palco2">
    <? unset($_SESSION['Matr']); ?>
      <form action="AlunoOK.php" method="post" enctype="multipart/form-data"  name="form1" >
	<fieldset id="forms">
    <!-- Dados do Aluno -->
		...
		<input type="text" name="Matricula" id="Matricula" class="textbox2" tabindex="2" onkeypress="formatar_mascara(this, '####-####-####')" onBlur="ajaxGet('processConsultaMatr.php?Matr='+this.value,document.getElementById('Matric'),true);" on maxlength="14"  title="Informe a matricula no Formato: AAAA-TTTT-SSSS"/>
      &nbsp;&nbsp;<input type="text" name="Matric" id="Matric" size="30" disabled readonly >
        <br />
		<br />
        <label for="Nome">Nome:</label>
		<input type="text" name="Nome" id="Nome" class="textbox"  tabindex="3" onkeypress="return Onlychars(event)" title="Informe o nome do aluno"/><br />
		<br />
        <label for="Data">Data da Matrícula:</label>
		<input type="text" name="Data" id="Data" class="textbox2"  tabindex="4" onKeyPress="MascaraData(form1.Data);"  size="14" maxlength="10" title="Informe a data da matrícula"/><br />
		<br />
		...
		<input type="text" name="Nascimento" id="Nascimento" class="textbox2"  tabindex="6" onKeyPress="MascaraData(form1.Nascimento);"  size="14" maxlength="10" title="Informe a data de mascimento"/><br />
		<br />
		...
		<input type="text" name="CelPai" id="CelPai" class="textbox2"  tabindex="14" onKeyPress="MascaraTelefone(form1.CelPai);" maxlength="15"  onBlur="ValidaTelefone(form1.CelPai);" title="Informe o Celular do Pai" /><br />
		<br />
		...
		<br />
        <label for="CelMae">Cel. Mãe:</label>
		<input type="text" name="CelMae" id="CelMae" class="textbox2"  tabindex="17"onKeyPress="MascaraTelefone(form1.CelMae);" maxlength="15"  onBlur="ValidaTelefone(form1.CelMae);" title="Informe o Celular da Mãe" /><br />
		<br />
        <label for="Profmae">Profiss&atilde;o da Mãe:</label>
      ...
      <!-- <label for="Foto">Foto:</label>
       ...
       <label for="Endereco">Endere&ccedil;o:</label>
		...
		<input type="text" name="Telefone" id="Telefone" class="textbox2"  tabindex="24" onKeyPress="MascaraTelefone(form1.Telefone);" maxlength="14"  onBlur="ValidaTelefone(form1.Telefone);" title="Informe o telefone residencial" /><br />
		<br />
        ...
        <select name="Transferencia"  class="textbox3" tabindex="26" title="Informe a origem da inclusão">
         ...
         <label for="Turma">Turma:</label><select name="Turma" id="Turma" class="textbox2" tabindex="27" >
           <option value="">Selecione</option>
        				<?php
			            //Busco os estados
        ...
        <input type="text" name="Carne" id="Carne" class="textbox2" tabindex="28" onkeypress="return Onlynumbers(event)" title="Informe o nº do Carnê" />

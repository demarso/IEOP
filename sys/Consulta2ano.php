...
<? include("head.php"); ?> 
 ...
 <div id="main">
  ...
  <br /><br /><br />
  <fieldset>
    	<legend>Consulta Dados do Aluno do 2&ordm; Ano</legend>
      ...
      <select name="Nome" id="Nome" class="textbox" onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)" d>
        <option value="" >Selecione</option>
         <?php
			            ...
			            //Busco os estados
						$sql3 = "SELECT a.Nome FROM aluno a, histMatr h WHERE a.Matricula = h.Matricula && a.Status = 'Ativo' && h.Turma = '2 Ano' && h.Ano = '$ano' ORDER BY h.Chamada";

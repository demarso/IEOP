...
<div id="main">
   ...
   <?
	...
	$_SESSION[turmanota] =  '4ano';
   // $sql5 = "DELETE FROM selecao";
	//$results15 = mysql_query($sql5);
	$ano = $_SESSION["AnoLetivo"];
   ?>
      <form action="Notas1.php" method="post" enctype="multipart/form-data" name="cadastro" >
	<fieldset id="forms">
		<legend>Lan&ccedil;a Recupera&ccedil;&atilde;o Final do Aluno do 4&ordm; ANO</legend><br /><br />
            ...
            <?
			 $sql = "SELECT DISTINCT Matricula FROM notas WHERE Recuperacao = 'Sim' && Ano = '$ano'";
						...
						$matr = $row['Matricula'];
		    			            ...
		    			            //Busco os estados
						$sql3 = "SELECT Nome FROM histMatr WHERE Matricula = '$matr' && Turma = '4 Ano' && Ano = '$ano' ORDER BY Nome";

...
$pdf->addJpegFromFile('img/logo_ieop.jpg',15,$pdf->y-40,60,60,"center");
...
$pdf->ezText(" INSTITUTO EDUCACIONAL OLIVEIRA PESSOA  ",10,array('justification'=>'center'));// Define o texto do seu pdf, e o tamanho da fonte;

$pdf->ezText(" Jardim Escola Pedacinho do Ceu  ",8,array('justification'=>'center'));

$pdf->ezText(" CNPJ: 86.737.210/0001-82  ",8,array('justification'=>'center'));

$pdf->ezText("Rua Dona Castorina, nº 93 - Vila Operária - Nova Iguaçu - RJ - Tel: (21) 3764-2593",8,array('justification'=>'center'));

//$pdf->ezText("Portaria de Autorização - nº 798 - D.O. 25/11/1998.",11,array('justification'=>'center'));

$pdf->ezText(" \nBOLETIM ESCOLAR   - $ano",10,array('justification'=>'center'));
...
$pdf->ezText("Nome:   $nome2a",10);	

 $pdf->ezText("Matricula: $matricula",8);
 
 $pdf->ezText("Ano de Escolaridade: $turma    Turma: $turmab",8);
 $pdf->ezText("\n");
 //$pdf->ezText("Turma: $turmab  ",8);
...
$pdf->ezText("Esta parte devera ser preenchida, destacada e devolvida a coordenacao da escola",8,array('justification'=>'center'));

//$pdf->ezText("\n");

$pdf->ezText("Responsavel: _____________________________________________________________",10);

$pdf->ezText("Nome do Aluno:  $nome2a",10);

$pdf->ezText("Ano de Escolaridade: $turma    Turma: $turmab                        Data recebida  _____/____/____",10);

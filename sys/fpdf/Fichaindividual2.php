...
$pdf->ezText("<b>\nFICHA INDIVIDUAL  -  ENSINO FUNDAMENTAL</b> - $ano\n",14,array('justification'=>'center'));
...
$pdf->ezText("<b>Nome:</b> $nome2    <b>Nascimento:</b> $nascimento",10);

$pdf->ezText("\n<b>Pai:</b> $pai",10);

$pdf->ezText("\n<b>Mãe:</b> $mae",10);

$pdf->ezText("\n<b>Endereço:</b> $endereco    <b>CEP:</b>  $cep",10);

$pdf->ezText("\n<b>Bairro:</b> $bairro    <b>Cidade:</b> $cidade    <b>Estado:</b> $estado",10);
...
if(!empty($dados3)){
    ...
    $pdf->ezText("<b>DEPENDÊNCIA  -  Ano:  $turmad1 $turmad2</b>\n");

...
<center>
<fieldset>
	<legend>Cadastrando lista pela chamada da Turma 9&ordm; Ano de <? echo $ano ?></legend>
<br />
...
<td align="center" style="width: 60%"><font color="#333333"><b>Nome</b></font></td>
 ...
 <?php
include "conexao.php";
$sq = "SELECT Matricula, Turma, Chamada FROM histMatr WHERE Turma = '9 Ano' && Ano = '$ano' ORDER BY Chamada";

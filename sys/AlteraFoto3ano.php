...
<? include("head.php"); ?> 
 ...
 <div id="main">
  <div id="palco2"><br /><br /><br />
  <fieldset>
    	<legend>Altera Foto do Aluno do 3º Ano</legend>
    <form name = "form1" method = "post" action = "Fotos_up.php" enctype = "multipart/form-data">
      ...
      <select name="Nome" id="Nome" class="textbox" onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)" d>
        ...
        <?php
			            ...
			            //Busco os estados
						$sql3 = "SELECT a.Nome FROM aluno a, histMatr h WHERE a.Nome = h.Nome && a.Status = 'Ativo' && h.Turma = '3º Ano' && h.Ano = '$ano' ORDER BY h.Chamada";

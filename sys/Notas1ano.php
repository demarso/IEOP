...
<div id="main">
   ...
   ?>
	...
	<fieldset id="forms">
		<legend>Lan&ccedil;a Notas do Aluno do 1&ordm; ANO</legend><br /><br />
  ...
  <select name="Nome" id="Nome" class="textbox" onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)" d>
           <option value="" >Selecione</option>
						...
						$sql3 = "SELECT a.Nome 
                     FROM aluno a
                     INNER JOIN histMatr h 
                     WHERE a.Nome = h.Nome and a.Status = 'Ativo' and h.Turma = '1 Ano' and h.Ano = '$ano' 
                     ORDER BY h.Chamada";

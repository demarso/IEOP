...
?>
 <div id="main">
   <div id="palco3">
     <fieldset>
	    <legend>Dados do Aluno para lan&ccedil;ar Depend&ecirc;ncias</legend>
			<br /><br />
            
            <label>Matr&iacute;cula:</label><br /><br />
            <label class="textbox3"><? echo $matricula; ?></label><br /><br /><br /><br />
             <div class="foto">
           <?  echo "<img src=\"$foto\" width='95' height='100' border='3'>"; ?>
           </div>

...
<? include("head.php"); ?> 
 ...
 <div id="main">
  ...
  <fieldset>
  <br /><br /><br />
    	<legend>Lan&ccedil;a Pagamento do Aluno do 8&ordm; Ano</legend>
    
      <form name = "form1" method = "post" action = "LancaPagamento1.php" enctype = "multipart/form-data">
  ...
  <br /><br /><br />
  <fieldset>
    	<legend>Lança Pagamento do Aluno do 8º Ano</legend>
        <option value="" >Selecione</option>
        <?php
						include ("conexao.php");
						$ano = $_SESSION["AnoLetivo"];
			            //Busco os estados
						$sql3 = "SELECT a.Nome FROM aluno a, histMatr h WHERE a.Matricula = h.Matricula && a.Status = 'Ativo' && h.Turma = '8 Ano' && h.Ano = '$ano' ORDER BY h.Chamada";

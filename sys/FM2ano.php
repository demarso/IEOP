...
<? include("head.php"); ?> 
 ...
 <div id="main">
  ...
  <br /><br /><br />
  <fieldset>
    	<legend>Imprime Ficha de Matrícula do Aluno do 2º Ano</legend>
    <form name = "form1" method = "post" action = "Ficha2.php" enctype = "multipart/form-data" target="_blank">
      ...
      <select name="Nome" id="Nome" class="textbox" onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)" d>
        ...
        <?php
			            ...
			            //Busco os estados
						$sql3 = "SELECT a.Nome FROM aluno a, histMatr h WHERE a.Nome = h.Nome && a.Status = 'Ativo' && h.Turma = '2º Ano' && h.Ano = '$ano' ORDER BY h.Chamada";

...
<div id="main">
   ...
   <div id="palco2"><br /><br />
	...
	<fieldset id="forms">
		<legend>Consulta Notas do Aluno</legend><br /><br />
   <label for="Nome">Nome:</label><select name="Nome" id="Nome" class="textbox"  onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)">

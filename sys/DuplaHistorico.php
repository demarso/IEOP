...
$sq = "SELECT id, Matricula FROM histMatr WHERE Ano = '$ano'";
      ...
      $sql = "SELECT id, Matricula FROM histMatr";
...
//	$query = mysql_query($sql = "DELETE FROM histMatr WHERE id = '$id2'") or die(mysql_error());	
?>
<center>

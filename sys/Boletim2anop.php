...
<div id="main">
   ...
   ?>
      <form action="Boletim2p.php" method="post" enctype="multipart/form-data" name="cadastro" target="_blank" >
	<fieldset id="forms">
		<legend>Imprime Boletim do Aluno do 2&ordm; ANO</legend><br /><br />
  ...
  <select name="Nome" id="Nome" class="textbox" onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)" >
           <option value="" >Selecione</option>
			            ...
			            //Busco os estados
						$sql3 = "SELECT a.Nome FROM aluno a, histMatr h WHERE a.Nome = h.Nome && a.Status = 'Ativo' && h.Turma = '2 Ano' && h.Ano = '$ano' ORDER BY h.Chamada";

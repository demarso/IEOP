...
$sq = "SELECT Matricula, Turma, Chamada FROM histMatr WHERE Turma = '1 Periodo' && Ano = '$ano' ORDER BY Chamada";
...
<div id='footer'>
 <a href="Imprime1Per.php" target="_blank"><img src="img/imprimir.jpg" width="120" height="22" align="left" /></a>
<? include("footer.php"); ?>
</div>
</div>
</center>

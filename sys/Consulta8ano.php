...
<? include("head.php"); ?> 
 ...
 <div id="main">
  ...
  <br /><br /><br />
  <fieldset>
    	<legend>Consulta Dados do Aluno do 8&ordm; Ano</legend>
    <form name = "form1" method = "post" action = "ConsAlunoOK.php" enctype = "multipart/form-data">

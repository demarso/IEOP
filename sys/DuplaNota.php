...
$sq = "SELECT id, Matricula, Materia FROM notas WHERE Ano = '$ano'";
      ...
      $sql = "SELECT id, Matricula, Materia FROM notas";
			...
			{ 
				...
				$materia2 = $linha2['Materia'];
				
		if($id2 > $id1 && $matric2 == $matric && $materia2 == $materia){
			
	//	$query = mysql_query($sql = "DELETE FROM notas WHERE id = '$id2'") or die(mysql_error());	
?>
<center>

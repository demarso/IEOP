...

{
    ...
    if($turma == "1 Ano") { $turma = "1º"; $turma2 = "111";}

    if($turma == "2 Ano") { $turma = "2º"; $turma2 = "121";}

    if($turma == "3 Ano") { $turma = "3º"; $turma2 = "131";}

    if($turma == "4 Ano") { $turma = "4º"; $turma2 = "141";}

    if($turma == "5 Ano") { $turma = "5º"; $turma2 = "151";}

    if($turma == "6 Ano") { $turma = "6º"; $turma2 = "161";}

    if($turma == "7 Ano") { $turma = "7º"; $turma2 = "171";}

    if($turma == "8 Ano") { $turma = "8º"; $turma2 = "181";}

    if($turma == "9 Ano") { $turma = "9º"; $turma2 = "191";}
...
$dados3[] = array('<b>Disciplina</b>'=>$materiaD,'<b>1º Bim</b>'=>$dep1,'<b>Faltas 1º</b>'=>$faltadep1,'<b>2º Bim</b>'=>$dep2,'<b>Faltas 2º</b>'=>$faltadep2,'<b>3º Bim</b>'=>$dep3,'<b>Faltas 3º</b>'=>$faltadep3,'<b>4º Bim</b>'=>$dep4,'<b>Faltas 4º</b>'=>$faltadep4,'<b>Pontos</b>'=>$totdep,'<b>Média</b>'=>$mostramediaD,'<b>Recup</b>'=>$recupDep);

...
$sq = "SELECT Matricula, Turma, Chamada FROM histMatr WHERE Turma = 'Maternal' && Ano = '$ano' ORDER BY Chamada";
...
$sql = "SELECT *,DATE_FORMAT(Nascimento,'%d/%m/%Y') as iNascimento,DATE_FORMAT(Data,'%d/%m/%Y') as iData FROM aluno WHERE Matricula = '$matricH'";
...
<div id='footer'>
 <a href="ImprimeMaternal.php" target="_blank"><img src="img/imprimir.jpg" width="120" height="22" align="left" /></a>
  <? include("footer.php"); ?>
</div>
</div>
</center>

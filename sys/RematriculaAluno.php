...
<div id="main">
  ...
  <label for="Matrícula">Nome:</label><select name="Nome" id="Nome" class="textbox"  onChange="ajaxGet('processConsultaGeral2.php?Nome='+this.value, document.getElementById('NascEx'), true)">
  ...
  <label for="Matrícula2">Nome:</label><select name="Nome2" id="Nome2" class="textbox"  onChange="ajaxGet('processConsultaGeral2.php?Nome='+this.value, document.getElementById('NascEx2'), true)">
           <option value="">Selecione</option>
        				<?php
			            //Busco os estados
						require_once("conexao.php");

...
<div id="main">
   ...
   ?>
	...
	<fieldset id="forms">
		<legend>Lan&ccedil;a Recupera&ccedil;&atilde;o Final do Aluno do 3&ordm; ANO</legend><br /><br />
            ...
            <?
			 $sql = "SELECT DISTINCT Matricula FROM notas WHERE Recuperacao = 'Sim' && Ano = '$ano'";
						...
						$matr = $row['Matricula'];
		    			            ...
		    			            //Busco os estados
						$sql3 = "SELECT Nome FROM histMatr WHERE Matricula = '$matr' && Turma = '3 Ano' && Ano = '$ano' ORDER BY Nome";

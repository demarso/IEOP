...
<? include("head.php"); ?> 
 ...
 <div id="main">
  ...
  <br /><br /><br />
  <fieldset>
    	<legend>Imprime Ficha individual do Aluno do 2&ordm; Período</legend>
      ...
      <select name="Nome" id="Nome" class="textbox" onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)" onMouseMove="ajaxGet('processConsultaGeral.php?Nome='+'', document.getElementById('Situacao'), true)">
        <option value="" >Selecione</option>
         <?php
			            ...
			            //Busco os estados
						$sql3 = "SELECT a.Nome FROM aluno a, histMatr h WHERE a.Nome = h.Nome && a.Status = 'Ativo' && h.Turma = '2 Período' && h.Ano = '$ano' ORDER BY h.Chamada";

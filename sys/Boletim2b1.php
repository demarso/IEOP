...
<div id="main">
   ...
   ?>
      <form action="Boletim2b.php" method="post" enctype="multipart/form-data" name="cadastro"  target="_blank">
	<fieldset id="forms">
		<legend>Imprime Boletim do Aluno do 1º ANO</legend><br /><br />
  ...
  <select name="Nome" id="Nome" class="textbox" onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)" >
		...
		<br /><br /><br />
          ...
          <input name="Situacao" id="Situacao"  class="textbox" size="100" onKeyUp="this.value = this.value.toUpperCase();" ></label>
          <br /><br /><br /><br />

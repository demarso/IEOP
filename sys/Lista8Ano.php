...
$sq = "SELECT Matricula, Turma, Chamada FROM histMatr WHERE Turma = '8 Ano' && Ano = '$ano' ORDER BY Chamada";
...
<div id='footer'>
 <a href="Imprime8Ano.php" target="_blank"><img src="img/imprimir.jpg" width="120" height="22" align="left" /></a>
<? include("footer.php"); ?>
</div>
</div>
</center>

...
$pdf->ezText("<b>\nLISTA DOS ALUNOS DA TURMA: 3º Período</b> - $ano\n\n",14,array('justification'=>'center'));
	...
	$sq = "SELECT a.Matricula as mat, a.Nome as nom, a.Nascimento as nasc, a.Status as stat, a.Turma as tur, h.Chamada as cham FROM aluno a, histMatr h WHERE a.Matricula = h.Matricula && h.Ano='$ano' && a.Turma = '3º Período' ORDER BY h.Chamada";

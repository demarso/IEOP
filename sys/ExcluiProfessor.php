...
<div id="main">
   ...
   <div id="palco2"><br /><br />
      <form action="ExcluiProfessorOK.php" method="post" enctype="multipart/form-data" name="cadastro" >
	<fieldset id="forms">
		<legend>Busca Professor para Exclus&atilde;o</legend><br /><br />
  <label for="Nome">Nome:</label><select name="Nome" id="Nome" class="textbox3" >
           <option value="">Selecione</option>
						...
						$results3 = mysqli_query($sql$sql3);

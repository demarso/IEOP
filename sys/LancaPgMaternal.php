...
<? include("head.php"); ?> 
 ...
 <div id="main">
  ...
  <br /><br /><br />
  <fieldset>
    	<legend>Lança Pagamento do Aluno do Maternal</legend>
      ...
      <select name="Nome" id="Nome" class="textbox" onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)" d>
        ...
        <?php
            ...
            $ano = $_SESSION["AnoLetivo"];
			            //Busco os estados
						$sql3 = "SELECT a.Nome FROM aluno a, histMatr h WHERE a.Matricula = h.Matricula && a.Status = 'Ativo' && h.Turma = 'Maternal' && h.Ano = '$ano' ORDER BY h.Chamada";

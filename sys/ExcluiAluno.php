...
<div id="main">
  ...
  <label for="Matrícula">Nome:</label><select name="Nome" id="Nome" class="textbox"  onChange="ajaxGet('processConsultaGeral.php?Nome='+this.value, document.getElementById('NascEx'), true)">
		...
		<select name="Transferencia"  class="textbox3" title="Informe a origem da inclusão">
    		<option value" "></option>
            <option value"Formatura">Formatura</option>
    		<option value"Transferência para Rede Particular">Transfer&ecirc;ncia para Rede Particular</option>
    		<option value"Transferência para Rede Pública">Transfer&ecirc;ncia para Rede P&uacute;blica</option>
    		<option value"Opção">Op&ccedil;&atilde;o</option>
            <option value"Expulsão">Expuls&atilde;o</option>
    	</select>
		<br /><br /><br />

...
$pdf->ezText("<b>\nLISTA DOS ALUNOS DA TURMA: 2º Ano</b> - $ano\n\n",14,array('justification'=>'center'));

			include "conexao.php";
			$cont = 1;
			
				
	$sq = "SELECT a.Matricula as mat, a.Nome as nom, a.Nascimento as nasc, a.Status as stat, a.Turma as tur, h.Chamada as cham FROM aluno a, histMatr h WHERE a.Matricula = h.Matricula && h.Ano='$ano' && a.Turma = '2º Ano' ORDER BY h.Chamada";

...
<div id="main">
   ...
   ?>
      <form action="NotasDepend1.php" method="post" enctype="multipart/form-data" name="cadastro" >
	<fieldset id="forms">
		<legend>Lan&ccedil;a Notas de Depend&ecirc;ncia do Aluno</legend><br /><br />
